...
print(cur.fetchone())  # ('1000',)`,
  changelog: {
    heading: "版本更新",
    releases: [
      { version: "v0.1.7", date: "2026-05-20", changes: ["原生 DBeaver/pgAdmin 兼容：系统目录查询拦截器", "扩展协议支持：Describe/Execute 消息正确处理", "异步无锁 WAL：crossbeam channel + 后台写入线程", "列式聚合缓存：向量化 f64 切片迭代", "SHOW USERS 与 INSERT INTO users 支持", "Web Portal 多标签页 Monaco SQL 编辑器"] },
